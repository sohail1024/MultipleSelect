...
angular.module('myApp.establishment', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/establishment', {
    templateUrl: 'establishment/establishment.html',
    controller: 'EstablishmentCtrl'
  });
}])

.controller('EstablishmentCtrl', ['$scope','$routeParams','$http',function($scope,$routeParams,$http) {
